...
export const menuSlice = createSlice({
    ...
    initialState: {
        menuLists: [
            ...
            { id: 'menu04', name: 'Installation', translateName: 'installation', url: '/installation', icon: 'treeQs', childrenLists: null },
            { id: 'menu05', name: 'Attendance', translateName: 'attendance', url: '/attendance', icon: 'treeQs', childrenLists: null },
            {
                id: 'menu06', name: 'LoginSystem', translateName: 'loginSystem', url: '/loginSystem', icon: null, childrenLists: [
                    { id: 'menu07', name: 'HasAccount', translateName: 'hasAccount', url: '/hasAccount', icon: 'treeQs', childrenLists: null },
                    { id: 'menu08', name: 'NotHasAccount', translateName: 'notHasAccount', url: '/notHasAccount', icon: 'treeQs', childrenLists: null },
                    { id: 'menu09', name: 'CreateAccount', translateName: 'createAccount', url: '/createAccount', icon: 'treeQs', childrenLists: null }
                ]
            },
            { id: 'menu10', name: 'MySummary', translateName: 'mySummary', url: '/mySummary', icon: 'treeQs', childrenLists: null },
            {
                id: 'menu11', name: 'TimesheetSystem', translateName: 'timesheetSystem', url: '/timesheetSystem', icon: null, childrenLists: [
                    { id: 'menu12', name: 'TimesheetSummary', translateName: 'timesheetSummary', url: '/timesheetSummary', icon: 'treeQs', childrenLists: null },
                    { id: 'menu13', name: 'NewTimesheetClockMode', translateName: 'newTimesheetClockMode', url: '/newTimesheetClockMode', icon: 'treeQs', childrenLists: null },
                    { id: 'menu14', name: 'NewTimesheetPercentMode', translateName: 'newTimesheetPercentMode', url: '/newTimesheetPercentMode', icon: 'treeQs', childrenLists: null },
                    { id: 'menu15', name: 'AddDateToTimesheet', translateName: 'addDateToTimesheet', url: '/addDateToTimesheet', icon: 'treeQs', childrenLists: null },
                ]
            },
            {
