    ...
    <BasePage  {...pageInfo}>
      <ContentPart title={"關於ATAL Mobile Access (AMA)"} sx={{ overflow: 'scroll' }}>
        ...
        <ol>
          ...
          <li><Typography variant='subtitle1' textAlign={'left'}>公司熱門資訊</Typography>
            <Typography variant='h6' textAlign={'left'}>包括內聯網資訊,通告,安全提示等</Typography>
          </li>
          <li><Typography variant='subtitle1' textAlign={'left'}> 費用報銷</Typography>
          ...
          <li><Typography variant='subtitle1' textAlign={'left'}> 考勤系統</Typography>
