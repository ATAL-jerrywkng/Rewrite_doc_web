  ...
  return (
    <BasePage  {...pageInfo}>
      <ContentPart title={"關於ATAL Mobile Access (AMA)"} sx={{ overflow: 'scroll' }}>
        ...
        <ol>
          <li> <Typography variant='subtitle1' textAlign={'left'}>將證明文件（如發票，收據等）放到系統上作審批。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>ECRS和考勤系統整合在一個平台上。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>在沒有網絡連線下，仍可在手機應用程序上進行資料輸入。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>即時提交報銷申請。不用月結形式遞交。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>提供港鐵八達通車費參考。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>支持繁簡體中文及英文。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>提供手機應用程式及網頁版本。</Typography></li>
          <li> <Typography variant='subtitle1' textAlign={'left'}>手機應用程式支援iOS和Android平台。</Typography></li>
        </ol>
